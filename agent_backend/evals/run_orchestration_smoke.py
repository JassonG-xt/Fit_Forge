...
def build_smoke_cases() -> list[SmokeCase]:
    return [
        ...
        SmokeCase(
            case_id="freeform-plan-clarify-or-generate",
            category="freeFormRouting",
            prompt=RAW_PROMPTS[7],
            expected_intent="generatePlan",
            expected_action_type="generatePlan",
            require_mutation_confirmation=True,
        ),
        SmokeCase(
            case_id="freeform-compress-20m",
            category="freeFormRouting",
            prompt=RAW_PROMPTS[8],
            expected_intent="compressWorkout",
            expected_action_type="compressWorkout",
            require_mutation_confirmation=True,
        ),
        ...
        SmokeCase(
            ...
            category="freeFormRouting",
            prompt=RAW_PROMPTS[10],
            expected_intent="nutritionAdvice",
            expected_action_type="nutritionAdvice",
            expect_no_mutation=True,
        ),
        SmokeCase(
            case_id="freeform-safety-over-plan",
            category="freeFormRouting",
            prompt=RAW_PROMPTS[11],
            expected_intent="safetyResponse",
            expected_action_type="safetyResponse",
            expect_no_mutation=True,
            expect_safety_response=True,
