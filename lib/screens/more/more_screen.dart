...
class MoreScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _navTile(context, '训练计划', '生成或更换个性化训练计划',
              Icons.auto_awesome, AppColors.primary, const PlanGeneratorScreen()),
          _navTile(context, '训练日历', '查看训练历史和安排',
              Icons.calendar_month, AppColors.back, const CalendarScreen()),
          _navTile(context, '成就', '你的健身里程碑',
              Icons.emoji_events, AppColors.warning, const AchievementsScreen()),
          const SizedBox(height: AppSpacing.lg),
          _sectionHeader(theme, '应用'),
          _navTile(context, '设置', '个人信息和应用配置',
              Icons.settings_outlined, AppColors.textSecondary, const SettingsScreen()),
        ],
      ),
    );
  }
  ...
  Widget _navTile(BuildContext context, String title, String subtitle,
