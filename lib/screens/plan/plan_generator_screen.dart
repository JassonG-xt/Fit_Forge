  ...
  Widget _planPreview() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                ...
                ChipTag(
                  ...
                  color: day.dayType == WorkoutDayType.rest ? AppColors.textTertiary : AppColors.primary,
                ),
              ]),
              if (day.dayType != WorkoutDayType.rest)
                ...day.exercises.map((e) => Padding(
                      ...
                      child: Row(children: [
                        Text('  ${e.exerciseName}', style: theme.textTheme.bodySmall),
                        const Spacer(),
                        Text('${e.targetSets}组×${e.targetReps}次', style: theme.textTheme.labelSmall),
                      ]),
                    )),
            ]),
          ),
      ...
      Row(children: [
        ...
        Expanded(child: GlowButton(label: '采用此计划', onPressed: _adopt)),
      ]),
    ]);
  }
