...
class Achievement {
  ...
  factory Achievement.fromJson(Map<String, dynamic> json) => Achievement(
    ...
    targetBodyPart: json['targetBodyPart'] != null
        ? BodyPart.values.byName(json['targetBodyPart'] as String)
        : null,
  ...
  Map<String, dynamic> toJson() => {
    ...
    'icon': icon,
    'threshold': threshold,
    'targetBodyPart': targetBodyPart?.name,
...
List<Achievement> defaultAchievements() => [
  ...
  Achievement(
    ...
    icon: '🎯',
    threshold: 20,
    targetBodyPart: BodyPart.chest,
  ),
  Achievement(
    id: 'a11',
    type: AchievementType.bodyPartMastery,
    title: '背部达人',
    description: '完成 20 次含背部训练',
    icon: '🎯',
    threshold: 20,
